...
extension LicenseTextModel {
    //TODO: -  Поменять текст политики
    static let privacyPolice: [LicenseTextModel] = [
        .init(
            title: "Privacy Policy",
            text: "This privacy policy applies to the MindfulCalm app (hereby referred to as 'Application') for mobile devices that was created by abeed (hereby referred to as 'Service Provider') as a Free service. This service is intended for use 'AS IS'."
        ),
        .init(
        ...
        .init(
            ...
            text: "The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at abeed908756@hotmail.com and they will respond in a reasonable time."
        ),
        .init(
            title: "Children",
            text: "The Service Provider does not use the Application to knowingly solicit data from or market to children under the age of 13.\n\n The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (abeed908756@hotmail.com) so that they will be able to take the necessary actions."
        ),
        .init(
            title: "Security",
    ...
    static let termsDataArray: [LicenseTextModel] = [
        ...
        .init(
            title: "Contact Us",
            text: "If you have any questions or suggestions about the Terms and Conditions, please do not hesitate to contact the Service Provider at abeed908756@hotmail.com."
        )
    ]
}
